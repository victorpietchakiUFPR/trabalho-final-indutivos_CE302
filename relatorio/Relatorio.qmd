...
```{r}
#| label: tabela de contingencia (faixa horaria e dia da semana)
#| eval: false
...
```{r}
#| label: quantidade de acidentes por ano (barplot)
...
```{r}
#| label: quantidade de acidentes por mes (barplot)
...
```{r}
#| label: quantidade de acidentes por data (timeseries)
...
```{r}
#| label: quantidade de acidentes por data e crepusculo civil (timeseries)
...
```{r}
#| label: quantidade de acidentes por data e faixa horaria (timeseries)
...
```{r}
#| label: severidade media por data (timeseries)
...
```{r}
#| label: quantidade de acidentes por ano e severidade (barplot)
